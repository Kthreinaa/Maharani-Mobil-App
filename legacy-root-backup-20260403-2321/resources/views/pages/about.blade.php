  ...
  <header class="bg-slate-50/70 dark:bg-slate-950/70 backdrop-blur-xl docked full-width top-0 sticky z-50">
    <nav class="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
      ...
      <div class="hidden md:flex items-center gap-10">
        <a class="text-slate-500 dark:text-slate-400 font-medium hover:text-[#F5A623] transition-colors duration-300 font-headline tracking-tight" href="/catalog">Catalog</a>
        <a class="text-[#1A2B4C] font-bold border-b-2 border-[#F5A623] pb-1 hover:text-[#F5A623] transition-colors duration-300 font-headline tracking-tight" href="/about">About Us</a>
        <a class="text-slate-500 dark:text-slate-400 font-medium hover:text-[#F5A623] transition-colors duration-300 font-headline tracking-tight" href="/financing">Financing</a>
      </div>
      <div class="flex items-center gap-6">
        ...
        <a class="text-[#1A2B4C] font-semibold hover:text-[#F5A623] transition-colors" href="/login">Login</a>
        <a class="bg-primary-container text-on-primary px-6 py-2 rounded-full font-bold hover:bg-primary transition-all active:scale-95" href="/register">Register</a>
      </div>
    </nav>
  </header>
    ...
    <section class="container mx-auto px-8 mb-24">
      <div class="bg-secondary-container rounded-3xl p-16 flex flex-col items-center text-center relative overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
          <a class="bg-primary text-white px-10 py-4 rounded-full font-bold text-lg hover:shadow-xl transition-all active:scale-95" href="/catalog">Explore Catalog</a>
          <a class="bg-white/30 backdrop-blur-md text-on-secondary-fixed border border-white/50 px-10 py-4 rounded-full font-bold text-lg hover:bg-white/50 transition-all active:scale-95" href="/test-drive">Contact Concierge</a>
        </div>
      </div>
    </section>
  </main>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 px-12 w-full max-w-screen-2xl mx-auto">
      ...
      <div class="flex flex-col gap-4">
        ...
        <nav class="flex flex-col gap-2">
          <a class="text-slate-400 hover:text-white underline transition-all font-label text-xs uppercase tracking-widest" href="/catalog">Inventory Catalog</a>
          <a class="text-slate-400 hover:text-white underline transition-all font-label text-xs uppercase tracking-widest" href="/financing">Finance Options</a>
          <a class="text-slate-400 hover:text-white underline transition-all font-label text-xs uppercase tracking-widest" href="/reviews">Reviews</a>
        </nav>
      </div>
      <div class="flex flex-col gap-4">
        <h5 class="text-white font-label text-xs uppercase tracking-widest font-bold">Legal</h5>
        <nav class="flex flex-col gap-2">
          <a class="text-slate-400 hover:text-white underline transition-all font-label text-xs uppercase tracking-widest" href="/privacy">Privacy Policy</a>
          <a class="text-slate-400 hover:text-white underline transition-all font-label text-xs uppercase tracking-widest" href="/terms">Terms of Service</a>
          <a class="text-slate-400 hover:text-white underline transition-all font-label text-xs uppercase tracking-widest" href="/faq">Cookie Settings</a>
        </nav>
      </div>
      <div class="flex flex-col gap-4">
