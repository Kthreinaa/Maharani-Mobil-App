      ...
      <div class="w-full max-w-md">
        ...
        <form class="space-y-6">
          ...
          <div class="flex items-start space-x-3 pt-2">
            ...
            <label class="text-sm font-body text-on-surface-variant" for="terms">I agree to the <a class="text-secondary font-bold hover:underline" href="/terms">Terms</a> and <a class="text-secondary font-bold hover:underline" href="/privacy">Privacy Policy</a>.</label>
          </div>
        ...
        <div class="mt-10 text-center">
          <p class="text-on-surface-variant font-body">
            ...
            <a class="text-secondary font-bold hover:underline transition-all" href="/login">Sign in</a>
          </p>
        </div>
      </div>
    </div>
