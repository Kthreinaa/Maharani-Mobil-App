...
<body class="bg-surface text-on-surface">
  <aside class="h-screen w-64 fixed left-0 top-0 border-r border-slate-100 dark:border-slate-800 bg-white dark:bg-[#031636] font-body text-sm flex flex-col h-full p-4 z-50">
    <div class="mb-10 px-4">
      <a class="text-xl font-bold text-[#1A2B4C] dark:text-[#F5A623]" href="/dashboard-marketing">Maharani Mobil</a>
    </div>
    ...
    <nav class="flex-1 space-y-2">
      <a class="bg-slate-100 dark:bg-white/10 text-[#1A2B4C] dark:text-white font-semibold rounded-lg px-4 py-3 flex items-center gap-3 transition-transform duration-200 hover:translate-x-1" href="/dashboard-marketing">
        <span class="material-symbols-outlined">dashboard</span>
        Dashboard
      </a>
      <a class="text-slate-500 dark:text-slate-400 hover:bg-slate-50 px-4 py-3 flex items-center gap-3 rounded-lg transition-transform duration-200 hover:translate-x-1" href="/marketing-products">
        <span class="material-symbols-outlined">directions_car</span>
        Manajemen Produk
      </a>
      <a class="text-slate-500 dark:text-slate-400 hover:bg-slate-50 px-4 py-3 flex items-center gap-3 rounded-lg transition-transform duration-200 hover:translate-x-1" href="/marketing-orders">
        <span class="material-symbols-outlined">leaderboard</span>
        Manajemen Pesanan
      </a>
      <a class="text-slate-500 dark:text-slate-400 hover:bg-slate-50 px-4 py-3 flex items-center gap-3 rounded-lg transition-transform duration-200 hover:translate-x-1" href="/marketing-offers">
        <span class="material-symbols-outlined">sell</span>
        Manajemen Penawaran
      </a>
      <a class="text-slate-500 dark:text-slate-400 hover:bg-slate-50 px-4 py-3 flex items-center gap-3 rounded-lg transition-transform duration-200 hover:translate-x-1" href="/marketing-upload">
        <span class="material-symbols-outlined">upload</span>
        Upload Produk
      </a>
    </nav>
    <div class="mt-auto pt-6 border-t border-slate-100 dark:border-slate-800 space-y-1">
      <a class="w-full mb-6 bg-[#feae2c] text-[#291800] font-bold py-3 rounded-xl shadow-lg shadow-secondary/20 hover:scale-105 transition-transform text-center block" href="/marketing-upload">Add New Listing</a>
      <a class="text-slate-500 dark:text-slate-400 hover:bg-slate-50 px-4 py-2 flex items-center gap-3 rounded-lg" href="/faq">
        <span class="material-symbols-outlined">help</span>
        Help Center
      </a>
      <a class="text-slate-500 dark:text-slate-400 hover:bg-slate-50 px-4 py-2 flex items-center gap-3 rounded-lg" href="/login">
