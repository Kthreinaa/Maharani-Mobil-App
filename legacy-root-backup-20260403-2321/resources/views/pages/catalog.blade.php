  ...
  <header class="bg-slate-50/70 dark:bg-slate-950/70 backdrop-blur-xl docked full-width top-0 sticky z-50">
    <div class="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
      ...
      <div class="flex items-center space-x-4">
        <a class="text-slate-500 font-medium px-4 py-2 hover:text-[#1A2B4C] transition-colors" href="/login">Login</a>
        <a class="bg-primary text-white font-bold px-6 py-2 rounded-lg hover:scale-95 transition-transform duration-200" href="/register">Register</a>
      </div>
    </div>
  </header>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          <div class="bg-surface-container-lowest rounded-xl overflow-hidden group shadow-sm hover:shadow-xl transition-all duration-300">
            ...
            <div class="p-6">
              ...
              <a class="w-full bg-surface-container-high text-primary font-bold py-3 rounded-lg group-hover:bg-secondary group-hover:text-white transition-all duration-300 block text-center" href="/car-detail">View Details</a>
            </div>
          </div>
          ...
          <div class="bg-primary text-white rounded-xl p-8 flex flex-col justify-between overflow-hidden relative col-span-1 md:col-span-2 shadow-sm">
            <div class="relative z-10">
              ...
              <a class="bg-secondary text-on-secondary-fixed font-bold px-8 py-3 rounded-lg hover:scale-105 transition-transform inline-block" href="/test-drive">Consult Our Concierge</a>
            </div>
