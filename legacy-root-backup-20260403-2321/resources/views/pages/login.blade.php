...
<head>
  ...
  <title>Maharani Mobil | Login</title>
  <meta name="description" content="Masuk ke akun Maharani Mobil untuk mengelola transaksi, penawaran, dan test drive."/>
    ...
    <div class="w-full md:w-1/2 bg-surface flex items-center justify-center p-6 md:p-16 lg:p-24 relative overflow-y-auto">
      ...
      <div class="w-full max-w-md">
        ...
        <div class="grid grid-cols-2 gap-4">
          <button class="flex items-center justify-center px-6 py-3 border border-outline-variant rounded-xl hover:bg-surface-container-low transition-colors font-body font-semibold text-on-surface group">
            <span class="material-symbols-outlined text-xl mr-2 text-on-surface-variant group-hover:text-primary transition-colors">google</span>
            Google
          </button>
          <button class="flex items-center justify-center px-6 py-3 border border-outline-variant rounded-xl hover:bg-surface-container-low transition-colors font-body font-semibold text-on-surface group">
            <span class="material-symbols-outlined text-xl mr-2 text-on-surface-variant group-hover:text-primary transition-colors">ios</span>
            Apple
          </button>
        </div>
  ...
  <footer class="bg-[#031636] w-full py-12 mt-auto">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 px-12 w-full max-w-screen-2xl mx-auto">
      ...
      <div class="flex flex-col gap-3">
        ...
        <a class="text-slate-400 font-label text-xs uppercase tracking-widest hover:text-white underline transition-all" href="/catalog">Catalog</a>
        <a class="text-slate-400 font-label text-xs uppercase tracking-widest hover:text-white underline transition-all" href="/financing">Financing</a>
      </div>
      <div class="flex flex-col gap-3">
        <span class="text-slate-500 font-label text-[10px] uppercase tracking-widest mb-2">Legal</span>
        <a class="text-slate-400 font-label text-xs uppercase tracking-widest hover:text-white underline transition-all" href="/privacy">Privacy Policy</a>
        <a class="text-slate-400 font-label text-xs uppercase tracking-widest hover:text-white underline transition-all" href="/terms">Terms of Service</a>
      </div>
      <div class="flex flex-col gap-4">
