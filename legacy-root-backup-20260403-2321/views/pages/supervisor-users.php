...
<head>
  ...
  <title>Manajemen User | Supervisor</title>
  <meta name="description" content="Kelola user customer, marketing, dan owner."/>
...
<body class="bg-surface text-on-surface">
  <aside class="h-screen w-64 fixed left-0 top-0 border-r border-slate-100 bg-white font-body text-sm flex flex-col p-4 z-50">
    ...
    <nav class="flex-1 space-y-2">
      ...
      <a class="bg-slate-100 text-[#1A2B4C] font-semibold rounded-lg px-4 py-3 flex items-center gap-3" href="supervisor-users.html"><span class="material-symbols-outlined">group</span>Manajemen User</a>
  ...
  <main class="ml-64 min-h-screen p-8">
    <h1 class="text-3xl font-extrabold text-primary mb-6">Manajemen User</h1>
    <!-- API: GET /api/users -->
        ...
        <table class="w-full text-left">
          ...
          <tbody class="divide-y divide-slate-50">
            <tr class="hover:bg-slate-50 transition-colors">
              <td class="px-8 py-5 font-semibold text-primary">Rina Aulia</td>
              <td class="px-8 py-5">Customer</td>
              <td class="px-8 py-5">rina@mail.com</td>
              <td class="px-8 py-5"><span class="bg-tertiary-fixed text-on-tertiary-fixed px-3 py-1 rounded-full text-xs font-bold">Active</span></td>
            ...
            <tr class="hover:bg-slate-50 transition-colors">
              <td class="px-8 py-5 font-semibold text-primary">Budi Santoso</td>
              <td class="px-8 py-5">Marketing</td>
              <td class="px-8 py-5">budi@maharani.id</td>
              <td class="px-8 py-5"><span class="bg-tertiary-fixed text-on-tertiary-fixed px-3 py-1 rounded-full text-xs font-bold">Active</span></td>
              <td class="px-8 py-5 text-right"><button class="px-3 py-1 rounded-lg border border-outline-variant text-xs font-bold">Detail</button></td>
            </tr>
          </tbody>
