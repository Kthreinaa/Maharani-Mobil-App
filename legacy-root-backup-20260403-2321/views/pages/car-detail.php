...
<body class="bg-background text-on-background min-h-screen flex flex-col">
  <header class="bg-slate-50/70 dark:bg-slate-950/70 backdrop-blur-xl docked full-width top-0 sticky z-50">
    <div class="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto font-headline tracking-tight">
      ...
      <div class="flex items-center gap-4">
        <a class="px-6 py-2 rounded-full font-semibold text-slate-500 hover:text-[#1A2B4C] transition-all" href="login.html">Login</a>
        <a class="px-6 py-2 rounded-full font-bold bg-primary-container text-white hover:scale-95 transition-all" href="register.html">Register</a>
      </div>
    </div>
  </header>
  ...
  <main class="max-w-screen-2xl mx-auto px-6 md:px-12 py-8 w-full flex-grow">
    ...
    <nav class="flex items-center gap-2 text-on-surface-variant text-sm mb-6 font-medium" aria-label="Breadcrumb">
      ...
      <a class="hover:text-primary" href="catalog.html">Inventory</a>
      <span class="material-symbols-outlined text-xs">chevron_right</span>
      ...
      <div class="lg:col-span-4">
        <div class="sticky top-24 space-y-6">
          ...
          <div class="bg-white p-6 rounded-2xl shadow-xl shadow-primary/5 border border-surface-container space-y-4">
            ...
            <a class="w-full bg-secondary-container hover:bg-secondary text-on-secondary-fixed py-4 rounded-xl font-bold flex items-center justify-center gap-3 transition-transform hover:-translate-y-1 shadow-lg shadow-secondary/10" href="test-drive.html">
              <span class="material-symbols-outlined">event</span>
              Buat Janji Test Drive
            </a>
            <a class="w-full bg-surface-container-low hover:bg-surface-container-high text-primary py-4 rounded-xl font-bold flex items-center justify-center gap-3 transition-all" href="offers.html">
          ...
          <div class="bg-surface-container-low p-6 rounded-2xl border border-dashed border-outline">
            ...
            <a class="text-xs font-bold text-secondary-container hover:underline flex items-center gap-1" href="financing.html">
    ...
    <div class="mt-20">
      <div class="flex items-end justify-between mb-8">
        ...
        <a class="font-bold text-primary flex items-center gap-1 hover:text-secondary-container transition-colors" href="catalog.html">
  ...
  <footer class="bg-[#031636] dark:bg-black w-full py-12 mt-auto text-white font-body text-xs uppercase tracking-widest">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 px-12 w-full max-w-screen-2xl mx-auto">
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-2">
          <li><a class="text-slate-400 hover:text-white underline transition-all" href="privacy.html">Privacy Policy</a></li>
          <li><a class="text-slate-400 hover:text-white underline transition-all" href="terms.html">Terms of Service</a></li>
        </ul>
      </div>
      <div class="space-y-4">
        <h5 class="font-bold text-white mb-2">Customer Care</h5>
        <ul class="space-y-2">
          <li><a class="text-slate-400 hover:text-white underline transition-all" href="faq.html">Cookie Settings</a></li>
          <li><a class="text-slate-400 hover:text-white underline transition-all" href="test-drive.html">Contact Support</a></li>
        </ul>
      </div>
      <div class="space-y-4">
