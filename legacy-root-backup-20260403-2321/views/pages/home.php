  ...
  <header class="bg-slate-50/70 backdrop-blur-xl sticky top-0 z-50">
    <div class="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
      ...
      <nav class="hidden md:flex items-center gap-8 font-headline tracking-tight">
        <a class="text-[#1A2B4C] font-bold border-b-2 border-[#F5A623] pb-1" href="home.html">Home</a>
  ...
  <main class="max-w-screen-2xl mx-auto w-full px-6 md:px-12 py-10 flex-grow">
    <section class="bg-primary rounded-3xl p-8 md:p-12 text-white mb-10">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        <div>
          <h1 class="text-4xl md:text-5xl font-extrabold">Selamat Datang Kembali</h1>
          <p class="text-blue-100 mt-2">Akses cepat untuk test drive, penawaran, dan tracking pesanan.</p>
        </div>
        <div class="flex gap-3">
          <a class="bg-secondary-container text-on-secondary-fixed px-6 py-3 rounded-xl font-bold" href="test-drive.html">Booking Test Drive</a>
          <a class="bg-white/10 border border-white/20 px-6 py-3 rounded-xl font-bold" href="order-tracking.html">Tracking Pesanan</a>
        </div>
      </div>
    </section>
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
      ...
      <div class="bg-white rounded-2xl p-6 shadow-xl shadow-blue-900/5">
        ...
        <p class="text-xl font-bold text-primary mt-2">Ajukan Penawaran</p>
        <a class="text-secondary font-bold" href="offers.html">Mulai sekarang →</a>
      </div>
    </section>

    <section>
      <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-extrabold text-primary">Unit Populer</h2>
        <a class="text-secondary font-bold" href="catalog.html">Lihat Katalog</a>
      </div>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-2xl overflow-hidden shadow-xl shadow-blue-900/5">
          <img class="w-full h-40 object-cover" alt="Honda Civic" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDJWY7D72T0YnbrV7D2n-6KfDmwMocsfTyDthwraZt3spp2IM1JjG_pWptdLbGc-vaH42NWoZslEq8CLQ0N39GaWA_-3EAF762tRGUxcNeFwbHmqXsiln7hEIpbjWkKxzrdXcw5SInqe1JxKze0moIYLz2f-NhDaYM5YUuC1Vzc1qS7792dLv3P1gqnwX3-AAezA7Y_MVrTZ8VlRGgV_uLk5KMaoN7WbFg1ON97mmRbRlW536dLH2ACDLQRAPvQ_EPXRXfWkygBgpk"/>
          <div class="p-5">
            <p class="font-bold text-primary">Honda Civic RS</p>
            <p class="text-sm text-on-surface-variant">Rp 480jt • 8.200 KM</p>
          </div>
        </div>
        <div class="bg-white rounded-2xl overflow-hidden shadow-xl shadow-blue-900/5">
          <img class="w-full h-40 object-cover" alt="Toyota Alphard" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB36HJqCR3wyD7bTSSQoSLk9jp_Xayq9466uxS8Ulwp5bicKy9CIRhnt3cDu5yQFtY2faDMQLEVBKvnP-20zlfBb2Gf6MHy6mHBjQfr4853HXkFu6tLmOoGvNbYy8QQx6gXxGdn6iVJUPEpjn-sN-r-SBXj-nWQ6kjUc8gY4As78a7q-TSHFd3bB3IEzsTWuZWsfU6LV36LQJ7-QowQXXQQF0vjJeT72f1LJk-4i-Ng94WLB3VT-u8U8QHVnH3rHVy4Fcj3BiNXt4c"/>
          <div class="p-5">
            <p class="font-bold text-primary">Toyota Alphard</p>
            <p class="text-sm text-on-surface-variant">Rp 1.150M • 12.400 KM</p>
          </div>
        </div>
        <div class="bg-white rounded-2xl overflow-hidden shadow-xl shadow-blue-900/5">
          <img class="w-full h-40 object-cover" alt="Mitsubishi Pajero" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD-XQJDRAiht3jmmKlm03BD8d8fkgdRLKKVuVoo9XK2ncsmiR5ElEMj_lTdRbdC9Hf5ABOnHCVnDBnx7vlta4kcEOIeznNW0Ez0L-FuaQabOpkXFLl0yDbHQP-gIJdP0F4mhoV9a_6Vjd1XYqj7Fl3Y-3I9meK4X-DIkTETybpZJb63w0kt-LAkuuV6dYIto14uGMO7d1Mbd9yAkQGBfw9WgGTxwD86KauPENfiFyjQyuk7ZV938YjqEsG_8Az-m4wgyxVl3k6wE6g"/>
          <div class="p-5">
            <p class="font-bold text-primary">Pajero Dakar</p>
            <p class="text-sm text-on-surface-variant">Rp 545jt • 35.000 KM</p>
          </div>
        </div>
      </div>
    </section>
