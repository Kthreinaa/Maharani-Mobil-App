...
<head>
  ...
  <meta name="description" content="Laporan penjualan bulanan Maharani Mobil."/>
...
<body class="bg-surface text-on-surface">
  <aside class="h-screen w-64 fixed left-0 top-0 border-r border-slate-100 bg-white font-body text-sm flex flex-col p-4 z-50">
    ...
    <nav class="flex-1 space-y-2">
      ...
      <a class="bg-slate-100 text-[#1A2B4C] font-semibold rounded-lg px-4 py-3 flex items-center gap-3" href="owner-sales.html"><span class="material-symbols-outlined">bar_chart</span>Laporan Penjualan</a>
  ...
  <main class="ml-64 min-h-screen p-8">
    <h1 class="text-3xl font-extrabold text-primary mb-6">Laporan Penjualan</h1>
    <!-- API: GET /api/reports/sales -->
    <section class="bg-white rounded-2xl shadow-xl shadow-blue-900/5 p-6">
      <div class="h-64 bg-surface-container-low rounded-xl flex items-center justify-center text-on-surface-variant">Sales Chart Placeholder</div>
      <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="bg-surface-container-low p-4 rounded-xl">
          <p class="text-xs uppercase tracking-widest text-on-surface-variant">Total Sales</p>
          <p class="text-2xl font-bold text-primary">Rp 3.2B</p>
        </div>
        <div class="bg-surface-container-low p-4 rounded-xl">
