...
<body class="bg-surface text-on-surface">
  <aside class="h-screen w-64 fixed left-0 top-0 border-r border-slate-100 bg-white font-body text-sm flex flex-col p-4 z-50">
    ...
    <nav class="flex-1 space-y-2">
      ...
      <a class="text-slate-500 hover:bg-slate-50 px-4 py-3 flex items-center gap-3 rounded-lg" href="marketing-offers.html"><span class="material-symbols-outlined">sell</span>Manajemen Penawaran</a>
      <a class="bg-slate-100 text-[#1A2B4C] font-semibold rounded-lg px-4 py-3 flex items-center gap-3" href="marketing-upload.html"><span class="material-symbols-outlined">upload</span>Upload Produk</a>
    </nav>
  ...
  <main class="ml-64 min-h-screen p-8">
    <header class="flex justify-between items-center mb-8">
      ...
      <a class="px-6 py-2 rounded-full border border-outline-variant font-semibold hover:bg-surface-container-low transition-colors" href="marketing-products.html">View Inventory</a>
    </header>
