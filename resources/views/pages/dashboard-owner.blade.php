...
<body class="bg-surface text-on-surface">
  <aside class="h-screen w-64 fixed left-0 top-0 border-r border-slate-100 bg-white font-body text-sm flex flex-col p-4 z-50">
    <div class="mb-10 px-4">
      <a class="text-xl font-bold text-[#1A2B4C]" href="/dashboard-owner">Maharani Mobil</a>
    </div>
    <nav class="flex-1 space-y-2">
      <a class="bg-slate-100 text-[#1A2B4C] font-semibold rounded-lg px-4 py-3 flex items-center gap-3" href="/dashboard-owner"><span class="material-symbols-outlined">dashboard</span>Dashboard</a>
  ...
  <main class="ml-64 min-h-screen p-8">
    ...
    <section class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white rounded-2xl shadow-xl shadow-blue-900/5 p-6">
        ...
        <a class="inline-block mt-4 text-secondary font-bold" href="/owner-revenue">Lihat detail pendapatan</a>
      </div>
      <div class="bg-white rounded-2xl shadow-xl shadow-blue-900/5 p-6">
        ...
        <a class="inline-block mt-4 text-secondary font-bold" href="/owner-performance">Analisis performa</a>
      </div>
    </section>
  </main>
</body>
